...
class HeroRoutes extends BaseRoute {
  ...
  create() {
    return {
      ...
      config: {
        ...
        notes: 'Cadatsra heroi por nome e poder',
        validate: {
          failAction,
          headers,
          payload: {
  ...
  update() {
    return {
      ...
      config: {
        tags: ['api'],
        description: 'Atualizar heroi por id',
        notes: 'Atualiza heroi por nome e poder',
        validate: {
          params: {
  ...
  delete() {
    return {
      ...
      config: {
        tags: ['api'],
        description: 'Excluir heroi por id',
        notes: 'Exclui heroi por id',
        validate: {
          failAction,
          headers,
          params: {
